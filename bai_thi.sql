...
VALUES (1, 'Dang Cong Thanh', 'Bac Ninh'),
       (2, 'tran xuan luc', 'Hanoi'),
       (3, 'BBD', 'Ho Chi Minh City');


INSERT INTO CustomerAccount (AccountNumber, CustomerID, Phone, Email, Balance)
VALUES (1001, 1, '1234567890', 'dangcongthanh@example.com', 5000.00),
       (1002, 2, '9876543210', 'tranxuanluc@example.com', 10000.00),
